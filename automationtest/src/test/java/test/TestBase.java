...
public class TestBase {
    ...
    public void setUp() throws MalformedURLException {
        ...
        desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, "com.huong.mycinema");
        //desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, ".activity.SplashScreenActivity");
        desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, ".ui.movielist.MovieListActivity");
